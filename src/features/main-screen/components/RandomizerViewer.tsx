...
import CXO2025Viewer from "@components/themes/cxo-2025/CXO2025Viewer";
    ...
    const renderViewer = useMemo(() => {
        switch (currentEvent) {
            case "ict-summit-2025":
                return <ICTSummitViewer />
            case "cxo-2025":
                return <CXO2025Viewer />
            default:
                return <div>No viewer found</div>
        }
    }, [currentEvent]);
